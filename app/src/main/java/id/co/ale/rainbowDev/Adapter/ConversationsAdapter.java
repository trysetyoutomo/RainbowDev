package id.co.ale.rainbowDev.Adapter;
...
import id.co.ale.rainbowDev.ChatActivity;
import id.co.ale.rainbowDev.ChatRoomActivity;
import id.co.ale.rainbowDev.Helpers.AvatarStream;
